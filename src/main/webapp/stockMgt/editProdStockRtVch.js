...
Ext.define('smartOA.stockMgt.EditProdStockRtVchPanel',
{
    ...
    constructor : function()
    {
        ...
        Ext.apply(this, 
        {
            ...
            auditorGroupId: smartOA.csn.getValue('PROD_RET_AUDITOR_GROUP_ID')
        });
...
Ext.onReady(function(){
    ...
    var formpanel = Ext.create('smartOA.stockMgt.EditProdStockRtVchPanel', 
                                {
                                    initId:win.initId, 
                                    parentStore:win.store,
                                    loadUrl:'stockMgt/loadProdStockRtVch.action',
                                    saveUrl: 'stockMgt/saveProdStockRtVch.action',
                                    updateStateUrl: 'stockMgt/updateStateForProdStockRtVch.action'}
                                );          
        
    win.add(formpanel);
    win.doLayout();   
    
/*     var formpanel = Ext.create('smartOA.stockMgt.EditProdOSPerOrderVchPanel', 
                                {
                                    initId:2, 
                                    parentStore:null,
                                    loadUrl:'stockMgt/loadProdOutstockPerOrderVch.action',
                                    saveUrl: 'stockMgt/saveProdOutstockPerOrderVch.action',
                                    updateStateUrl: 'stockMgt/updateStateForProdOutstockPerOrderVch.action'}
                                );          
