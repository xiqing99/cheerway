...
Ext.define("salesMgt.SalesReportPerCustPanel",
{   
    ...
    {                  
        Ext.apply(this, {      
            ...
            columns: [
              ...
              {text : '客户区域',  sortable : true, width : 120, align : 'center'},
              {text : '客户名称',  filter:true, sortable : true, width : 120, align : 'center'},
              {text : '货柜量',  filter:true, sortable : true, width : 120, align : 'center'},
              {text : '结算货币',  filter:true, sortable : true, width : 120, align : 'center'},
              {text : "总金额" , width : 100, align : 'center'},
              {text : "超额利润" , width : 100, align : 'center'}
//              {text : "总金额(¥)" , width : 100, align : 'center'}
              ],            
            selType: 'rowmodel'
        });
    ...
    loadData: function()
    {
        ...
        var columns = [
              ...
              {text : "货柜量" , dataIndex : 'ctnNum', width : 100, align : 'center', summaryType: 'sum'}, 
              {text : "总金额" , dataIndex : 'totalPrice', width : 150, align : 'center', renderer:moneyRendererFun}, 
              {text : "总金额(¥)" , dataIndex : 'totalPriceInCn', width : 150, align : 'center',summaryType: 'sum',
                    renderer:function(value)
                    {
                        return Ext.util.Format.currency(value, '¥');
                    },
                    summaryRenderer: function(value, summaryData, dataIndex) {
                        var my = ((value === 0 || value > 1) ?  Ext.util.Format.currency(value, '¥')  : 0);
                        
                        return "<p style='color:red'>"+my+"</p>";
                    }                      
              },
              {text : "超额利润(¥)" , dataIndex : 'totalProfitInCn', width : 150, align : 'center',summaryType: 'sum', 
                    renderer:function(value)
                    {
                        return Ext.util.Format.currency(value, '¥');
                    },
        ...
        while(date.getTime() < endDate.getTime())
        {
            ...
            columns.splice(-4,0, {text : dateText+'货柜量' , dataIndex : 'ctnNum'+index, width : 100, align : 'center',summaryType: 'sum'});
            columns.splice(-4,0, {text : dateText+'金额' , dataIndex : 'price'+index, width : 150, align : 'center', renderer:moneyRendererFun});

            
            field.push({name: 'price'+index, type: 'float'});
            field.push({name: 'ctnNum'+index, type: 'float'});
