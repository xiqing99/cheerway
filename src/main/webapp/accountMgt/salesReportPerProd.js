...
Ext.define("accountMgt.SalesReportPerProdPanel",
{   
...
Ext.onReady(function() {
    ...
    var listPanel = Ext.create('accountMgt.SalesReportPerProdPanel', 
            {loadUrl:'accountMgt/loadSaleReportPerProd.action'});    
