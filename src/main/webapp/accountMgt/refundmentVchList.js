...
Ext.define('smartOA.accountMgt.RefundmentVchListPanel',
{   
    extend : "smartOA.commonClass.EditDateRangeGridPanel",
    constructor : function(conf)
    { 
        
        Ext.define('RefundmentVch',{
        ...
        Ext.apply(this, {   
            loadUrl : 'accountMgt/loadRefundmentVchListByCreatedDateRange.action',
            delUrl: 'accountMgt/delRefundmentVch.action',       
            dataModel: 'RefundmentVch', 
            ...
            columns: [
              ...
              {text : "单据状态" , dataIndex : 'state', sortable : true, width : 100, align : 'center',
                ...
                {text : "订单号" , dataIndex : 'saleVchSeqNum', sortable : true, width : 150, align : 'center'},       
              {text : "结算货币" , dataIndex : 'currencyName',  width : 100, align : 'center'},
              {text : "付款金额" , dataIndex : 'totalAmount', sortable : true, width : 150, align : 'center',
    ...
    {    
        smartOA.util.genWindow({
                loader: {
                url: 'accountMgt/editRefundmentVch.js',
                autoLoad: true,
                scripts:true
            },
            title: '退款单',
...
Ext.onReady(function() {
    ...
    var framePanel = Ext.create('smartOA.accountMgt.RefundmentVchListPanel');       
