...
Ext.define("smartOA.accountMgt.DepositPerOrderListGridPanel",
{   
    ...
    { 
        ...
        Ext.apply(this, {         
            loadUrl: 'accountMgt/loadDepositAmountPerOrderList.action',
            editUrl: '',
            dataModel: 'DepositPerOrder',  
            columns: [
              ...
              {text : "订单号" , dataIndex : 'vchSeqNum', sortable : true, width : 180, align : 'center'},
...
Ext.onReady(function() {
    ...
    var listPanel = Ext.create('smartOA.accountMgt.DepositPerOrderListGridPanel');         
